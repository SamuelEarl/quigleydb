...
* Or I could allow for required and default values and I would reconstruct the query string based on any default values, as opposed to trying to inject default values into the existing query string.
